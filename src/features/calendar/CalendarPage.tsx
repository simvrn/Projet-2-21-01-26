      ...
      <Card className="overflow-hidden">
        ...
        <div className={`grid grid-cols-7 ${view === 'week' ? 'min-h-[500px]' : ''}`}>
          {days.map((day, idx) => {
            ...
            // En vue mois, cases invisibles pour les jours hors du mois courant
            ...
            return (
              <div
                ...
                className={`min-h-[100px] ${view === 'week' ? 'min-h-[500px]' : ''} p-2 border border-dark-700/50 rounded-lg cursor-pointer hover:bg-dark-700/30 transition-colors ${
                  isToday ? 'border-4 border-red-500 bg-red-500/10' : ''
                }`}
              >
